key_switch_camera = 'z' # камера прив'язана до героя чи ні
key_switch_mode = 'x' # можно проходити через загородження чи ні

key_forward = 's'   # крок вперед (туди куди дивиться камера)
key_back = 'w'      # крок назад
key_left = 'd'      # крок вліво (вбік від камери)
key_right = 'a'     # крок вправо
key_up = 't'      # крок вверх
key_down = 'r'     # крок вниз

key_turn_left = 'c'     # поворот камери направо (а світу - налево)
key_turn_right = 'v'    # поворот камеры налево (а світу - направо) 

key_build = 'f'     # поставити блок перед собою
key_destroy = 'g'   # поламати блок перед собою


class Hero():
    def __init__(self, pos, land):
        self.land = land
        self.mode = True # режим проходження через все
        self.hero = loader.loadModel('panda')
        self.hero.setColor(1, 1, 1)
        self.hero.setScale(0.04) 
        self.hero.setH(180)
